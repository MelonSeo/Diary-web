        ...
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <div className={styles.cardContent}>
                    ...
                    >
                        {isPending ? "연결 중..." : <img src="/images/kakao_login_button.png" alt="카카오 로그인" style={{ height: '48px' }} />} {/* 로딩 상태에 따라 텍스트 변경 */}
                    </button>

                    {/* 구글 로그인 버튼 */}
                    <button className="gsi-material-button" onClick={() => signIn("google")} type="button">
                      <div className="gsi-material-button-state"></div>
                      <div className="gsi-material-button-content-wrapper">
                        <div className="gsi-material-button-icon">
                          <svg version="1.1" viewBox="0 0 48 48" style={{display: "block"}} role="img" aria-hidden="true" focusable="false">
