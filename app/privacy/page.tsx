 ...
 * @description 개인정보처리방침 페이지의 Next.js Server Component.
 */

export const metadata: Metadata = {
    title: "개인정보처리방침 - 나의 일기장",
    description: "나의 일기장 서비스의 개인정보처리방침을 안내합니다.",
};

export default function PrivacyPolicyPage() {
    return (
        <div className={styles.container}>
            <main className={styles.mainContent} style={{ textAlign: 'left', maxWidth: '800px', margin: '0 auto' }}>
                <section className={styles.heroSection}>
                    <h1 className={styles.heroTitle}>개인정보처리방침</h1>
                    <p className={styles.heroDescription}>
                        나의 일기장 서비스는 사용자의 개인정보를 소중하게 생각하며, 정보통신망 이용촉진 및 정보보호 등에 관한 법률을 준수하고 있습니다.
                    </p>
                </section>

                <section style={{ marginTop: '2rem' }}>
                    <p>AI일기장(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</p>
                    <br/>
                    ...
                    <ol>
                        <li>1. 홈페이지 회원 가입 및 관리<br/>
                            회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 서비스 부정 이용 방지, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.</li>
                        <li>2. 재화 또는 서비스 제공<br/>
                            콘텐츠 제공, 맞춤서비스 제공 등을 목적으로 개인정보를 처리합니다.</li>
                        <li>3. 고충 처리<br/>
                    ...
                    <ol>
                        <li>1. 홈페이지 회원 가입 및 관리 : 홈페이지 탈퇴 시까지<br/>
                    ...
                    <ol>
                        <li>1. 홈페이지 회원 가입 및 관리<br/>
                            필수항목 : 이메일, 이름(닉네임), 프로필 사진, 소셜로그인 제공자 정보(Google, Kakao)<br/>
                            선택항목 : 없음</li>
                    </ol>
                    <br/>
                    ...
                    <ol>
                        ...
                        <li>2. 파기 방법<br/>
                            회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 파기합니다.</li>
                    </ol>
                    <br/>
                    ...
                    <p>이 개인정보 처리방침은 2025. 11. 8. 부터 적용됩니다.</p>
                </section>
