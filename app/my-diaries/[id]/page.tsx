...
export default async function DiaryPage({ params }: PageProps) {
    ...
    try {
        ...
        return <DiaryView diary={serializableDiary} />;
    } catch (error) {
        ...
        const mockDiary: DiaryEntry = {
            ...
            images: [
                ...
                { id: Long.fromNumber(2), url: '/placeholder.svg?height=400&width=600&text=Sample+Image+2', filename: 'sample2.jpg', size: 1024, mimeType: 'image/jpeg' },
            ],
        ...
        const serializableMockDiary = {
            ...
            images: mockDiary.images.map(img => ({
                ...img,
                id: img.id.toString(),
            })),
        };

        return <DiaryView diary={serializableMockDiary} />;
    }
}
